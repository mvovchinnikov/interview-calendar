...
import com.example.calendar.dto.PublicAvailabilityResponse;
...
import com.example.calendar.service.AvailabilityService;
import com.example.calendar.service.BookingService;
import com.example.calendar.service.UserService;
import com.example.calendar.service.EventTypeService;
...
public class PublicCalendarController {
    ...
    public List<PublicBookingResponse> bookings(
        ...
        User developer = userService.getDeveloperByToken(token);
        HrRole viewer = asRole != null ? HrRole.valueOf(asRole) : null;
